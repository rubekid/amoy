        ...
        <span class="spinner-holder">
          ...
          <span v-if="state == 2">
            <slot name="refresh-spinner">
              <refresh-spinner :style="{fill: refreshLayerColor, stroke: refreshLayerColor}"></refresh-spinner>
            </slot>
          </span>
        </span>
      </div>
      ...
      <div v-if="showInfiniteLayer" class="loading-layer">
        <span class="spinner-holder" :class="{'active': showLoading}">
          <slot name="infinite-spinner">
            <infinite-spinner :style="{fill: loadingLayerColor, stroke: loadingLayerColor}"></infinite-spinner>
          </slot>
        </span>
...
<script>
  ...
  import InfiniteSpinner from './InfiniteSpinner.vue'
  import RefreshSpinner from './RefreshSpinner.vue'
